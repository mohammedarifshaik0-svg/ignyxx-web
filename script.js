...
// Use the official horizontal IGNYXX mark in the top-left header only.
const brand = document.querySelector('.topbar .brand');
if (brand) {
  brand.innerHTML = '<img src="ignyxx-horizontal-logo.svg" alt="IGNYXX" style="display:block;width:auto;height:34px;max-width:180px;object-fit:contain;object-position:left center">';
}
